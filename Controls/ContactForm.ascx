...
<table class="auto-style1" runat="server" id="FormTable">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="The e-mail addresses don’t match" Text="*" Display="Dynamic" CssClass="ErrorMessage" ControlToValidate="ConfirmEmailAddress"></asp:CompareValidator>
        </td>
    </tr>
    <tr>
